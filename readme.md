...
| File                                                                                                                                                              | Desc                                                                                          |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| [mujoco_dual_ur5e_server](mujoco_dual_ur5e_server.py)<br>[mujoco_dual_ur5e_client](mujoco_dual_ur5e_client.py)<br>doc: [dual_ur5e_server.md](docs/dual_ur5e_server.md) | server loads 2 ur5e.<br>client is an example that drives robot to perform sinusoidal movement |
